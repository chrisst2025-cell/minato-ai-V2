  ...
  onStart: async function ({ message, event, api }) {
    try {
      ...
      if (args[0].toLowerCase() === "list") {
        const fontList = `✨ 𝐀𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐅𝐨𝐧𝐭 𝐒𝐭𝐲𝐥𝐞𝐬 ✨
━━━━━━━━━━━━━━━━━━━━☆
...
31 ⟶ ΣЩ’Я ƧΛIM
━━━━━━━━━━━━━━━━━━━━━☆`;
        return api.sendMessage(fontList, event.threadID, event.messageID);
      }
      ...
      const response = await axios.get(`${baseUrl}/api/font`, { params: { id, text } });
      ...
      console.error(err);
      return api.sendMessage("❌ 𝐎𝐨𝐩𝐬! Something went wrong, please try again later.", event.threadID, event.messageID);
    }
  }
};
